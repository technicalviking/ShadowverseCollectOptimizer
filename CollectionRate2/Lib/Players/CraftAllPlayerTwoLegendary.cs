...
{
    public class CraftAllPlayerTwoLegendary : IPlayer
    {
        public int curVials;
        ...
        public CraftAllPlayerTwoLegendary(ICollectionCompletionStrategy ccs, IRarityStrategy rs, IDupeStrategy ds)
        {
            compStrat = ccs;
            ...
            name = string.Format("CAP2L_{0}_{1}_{2}", rarityStrat, dupeStrat, completenessStrat);
        }
