...
{
    public class CraftAllBaseSetTwoLegendary
    {
        ...
        {
            new Default(),
            new DefaultTwoLegendary(),
            new FirstThreeUsable(),
            new FirstUsableTwoLegendary(),
            new NukeAnimated(),
            new NukeAnimatedTwoLegendary()
        };
        ...
        public CraftAllBaseSetTwoLegendary()
        {
            craftRarityStrategies.ForEach(crs =>
            {
                craftDupeStrategies.ForEach(cds =>
                {
                    ...
                    {
                        CraftAllPlayerTwoLegendary cap2 = new CraftAllPlayerTwoLegendary(ccs, crs, cds);
                        players.Add(cap2);
                        runs.Add(cap2.name, new int[MAXRUNS]);
